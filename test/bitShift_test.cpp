...
TEST_CASE("Segment shifting does not change 0", "[Segment Bit Shift 0]") {
    ...
    SECTION("Segment Shifting uint64_t{0}") {
        REQUIRE(sgmnt_bit_shift_l<uint64_t, uint64_t>(uint64_t{0}, 1) == uint64_t{0});
        REQUIRE(sgmnt_bit_shift_r<uint64_t, uint64_t>(uint64_t{0}, 1) == uint64_t{0});

        REQUIRE(sgmnt_bit_shift_l<uint64_t, uint32_t>(uint64_t{0}, 1) == uint64_t{0});
        REQUIRE(sgmnt_bit_shift_r<uint64_t, uint32_t>(uint64_t{0}, 1) == uint64_t{0});

        REQUIRE(sgmnt_bit_shift_l<uint64_t, uint16_t>(uint64_t{0}, 1) == uint64_t{0});
        REQUIRE(sgmnt_bit_shift_r<uint64_t, uint16_t>(uint64_t{0}, 1) == uint64_t{0});

        REQUIRE(sgmnt_bit_shift_l<uint64_t, uint8_t>(uint64_t{0}, 1) == uint64_t{0});
        REQUIRE(sgmnt_bit_shift_r<uint64_t, uint8_t>(uint64_t{0}, 1) == uint64_t{0});
    }

    SECTION("Segment Shifting uint32_t{0}") {
        REQUIRE(sgmnt_bit_shift_l<uint32_t, uint32_t>(uint32_t{0}, 1) == uint32_t{0});
        REQUIRE(sgmnt_bit_shift_r<uint32_t, uint32_t>(uint32_t{0}, 1) == uint32_t{0});

        REQUIRE(sgmnt_bit_shift_l<uint32_t, uint16_t>(uint32_t{0}, 1) == uint32_t{0});
        REQUIRE(sgmnt_bit_shift_r<uint32_t, uint16_t>(uint32_t{0}, 1) == uint32_t{0});

        REQUIRE(sgmnt_bit_shift_l<uint32_t, uint8_t>(uint32_t{0}, 1) == uint32_t{0});
        REQUIRE(sgmnt_bit_shift_r<uint32_t, uint8_t>(uint32_t{0}, 1) == uint32_t{0});
    }

    SECTION("Segment Shifting uint16_t{0}") {
        REQUIRE(sgmnt_bit_shift_l<uint16_t, uint16_t>(uint16_t{0}, 1) == uint16_t{0});
        REQUIRE(sgmnt_bit_shift_r<uint16_t, uint16_t>(uint16_t{0}, 1) == uint16_t{0});

        REQUIRE(sgmnt_bit_shift_l<uint16_t, uint8_t>(uint16_t{0}, 1) == uint16_t{0});
        REQUIRE(sgmnt_bit_shift_r<uint16_t, uint8_t>(uint16_t{0}, 1) == uint16_t{0});
    }

    SECTION("Segment Shifting uint8_t{0}") {
        REQUIRE(sgmnt_bit_shift_l<uint8_t, uint8_t>(uint8_t{0}, 1) == uint8_t{0});
        REQUIRE(sgmnt_bit_shift_r<uint8_t, uint8_t>(uint8_t{0}, 1) == uint8_t{0});
    }
